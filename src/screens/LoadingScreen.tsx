...
import {AreYouText, COLORS, ReadyButton, ReadyButtonText, RumBleText } from '../components/Stylesheet';
import { RootStackParamList } from '../navigation';

type loadingStack = NativeStackNavigationProp<
  RootStackParamList,
  "Loading"
>;
...
//      <Image style={{width: 80, height: 80}} source={require("../../assets/backgroundImage.png")}/>
  return (
    <View style={{flex: 1}} >
      <ImageBackground resizeMode='cover' style={{flex: 1, justifyContent: "center"}} source={require("../../assets/backgroundImage.png")}>
